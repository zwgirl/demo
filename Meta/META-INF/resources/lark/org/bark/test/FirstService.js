(function(){ 
  ...
  FirstService.prototype.sayHello = function(message, r, r1){
    try{
      return __invoke(new (__lc("org.bark.remoting.RemotingModel"))(arguments[arguments.length-1], "sayHello", [String.prototype.__class, __lc("org.bark.test.Result").prototype.__class, __lc("org.bark.test.Result").prototype.__class], [message, r, r1]));
    }catch(e){
      throw e;
    }
  };
