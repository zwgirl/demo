...
HashMap.call(this, Math.max(m.size / HashMap.DEFAULT_LOAD_FACTOR + 1, HashMap.DEFAULT_INITIAL_CAPACITY), HashMap.DEFAULT_LOAD_FACTOR);
  ...
  HashMap.prototype.__class = new (__lc('java.lang.Class'))("java.util.HashMap", HashMap, __lc("java.util.AbstractMap").prototype.__class, [__lc("java.util.Map").prototype.__class, __lc("java.lang.Cloneable").prototype.__class, __lc("java.io.Serializable").prototype.__class], 1);
  return  HashMap;
})();